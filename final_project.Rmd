...
```
```{r}
# I want to see how many tracks from playlists exist in songs df
# Find the common track_ids between playlist_subset_fixed and playlist_df
common_track_ids <- intersect(playlist_subset_fixed$track_id, playlist_df$track_id)

# Count how many common track_ids exist
num_common_track_ids <- length(common_track_ids)

# Print the result
print(num_common_track_ids)
```
